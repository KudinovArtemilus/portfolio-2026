...
- ![🛑](https://fonts.gstatic.com/s/e/notoemoji/17.0/1f6d1/32.png) Отказоустойчивость бэкенда: Текущая архитектура — одиночный сервер. При критической эксплуатации потребуется внедрение кластера (Docker Swarm/K8s).
- ![🔒](https://fonts.gstatic.com/s/e/notoemoji/17.0/1f512/32.png) Шифрование трафика: В базе настроен HTTP. Для внешней сети (через Интернет) необходимо развернуть SSL-сертификаты для HTTPS/WSS.
- ![📲](https://fonts.gstatic.com/s/e/notoemoji/17.0/1f4f2/32.png) Каналы уведомлений: Оповещения пока живут только внутри браузера. Системе "не хватает" интеграции с Telegram или Email-ботами.
- ![🔌](https://fonts.gstatic.com/s/e/notoemoji/17.0/1f50c/32.png) Закрытость протоколов: На данный момент драйвер сфокусирован на S7. Для универсальности стоит добавить поддержку Modbus и OPC UA.
- ![🖥️](https://fonts.gstatic.com/s/e/notoemoji/17.0/1f5a5_fe0f/32.png) Нагрузка на браузер: При выводе сотен графиков на один экран нагрузка на процессор клиента может быть высокой.
`;
