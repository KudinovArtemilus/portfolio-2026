...
- **Выбор кодека записи:** В настройках доступен выбор между различными кодеками (H.264, H.265 и др.), что позволяет настроить оптимальный баланс между качеством видео и нагрузкой на процессор.
...
- **Доступ к настройкам:** В системном трее Windows кликните по иконке программы правой или левой кнопкой мыши и выберите "Развернуть окно". Здесь можно нажать **"Настройки ⚙"**, чтобы изменить путь к сохранению, выбрать **Кодек записи** или **Сменить пароль**.
